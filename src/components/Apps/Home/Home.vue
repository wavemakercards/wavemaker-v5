...
import GridLogger from "@/components/Dashboard/GridLogger.vue";
export default {
  name: "ProjectHome",
  components: {
    Logo,
...
<div class="mainnav">
  ...
  <button @click="$root.currentTool = 'writer'">    <svg data-v-92328502="" version="1.1" viewBox="0 0 24 24">
            <path
              data-v-92328502=""
  ...
  <button @click="$root.currentTool = 'gridplanner'">
      ...
      <button @click="$root.currentTool = 'mindmap'">   <svg data-v-92328502="" version="1.1" viewBox="0 0 24 24">
            <path
              data-v-92328502=""
          ...
          Mindmap Builder</button>

          <button @click="$root.currentTool = 'timeline'">    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        Timeline Creator</button>


        <button @click="$root.currentTool = 'snowflake'">    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        Snowflake Tool</button>


        <button @click="$root.currentTool = 'cardsdatabase'">        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
