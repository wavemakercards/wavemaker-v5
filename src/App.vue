...
<template>
  ...
  <div id="navbar">
    ...
    <button class="navbtn" @click="$root.currentTool = 'gridplanner'">
    ...
    <button class="navbtn" @click="$root.currentTool = 'mindmap'">
      <svg data-v-92328502="" version="1.1" viewBox="0 0 24 24">
        <path
          data-v-92328502=""
    ...
    <button class="navbtn" @click="$root.currentTool = 'timeline'">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <button class="navbtn" @click="$root.currentTool = 'snowflake'">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <button class="navbtn" @click="$root.currentTool = 'cardsdatabase'">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<style>
:root {
  --wm-main-background: #f2ece9;
  --wm-main-foreground: #212121;

  --wm-logo-top: var(--accent0);
  --wm-logo-bottom: var(--accent0-dark);
  ...
  --info: #1a62c0; /* blue */
  --warning: #f7941d;
  --success: #27c46a; /* green */
  --danger: #c42727; /* red */

  /* Accent foregrounds (contrasting text) */
  --accent0-fg: #212121;
  --accent1-fg: #fff;
  --accent2-fg: #fff;
  --info-fg: #fff;
  ...
  /* Light versions */
  --accent0-light: #efefef;
  --accent1-light: #bca6e6;
  --accent2-light: #f7a3c1;
  --info-light: #a3c8f7;
  --warning-light: #ffe0b2;
  --success-light: #a8eac6;
  --danger-light: #f7b2b2;

  --accent0-light-fg: #212121;
  --accent1-light-fg: #212121;
  --accent2-light-fg: #212121;
  --info-light-fg: #212121;
  --warning-light-fg: #212121;
  --success-light-fg: #212121;
  --danger-light-fg: #212121;
...
#navbar {
  ...
  /* Style for direct child buttons */
  .navbtn {
    width: 32px;
    height: 32px;
    margin: 0px 9px;
...
.wm-logo {
  .wm-logo-top {
    fill: var(--wm-logo-top);
  }

  .wm-logo-bottom {
    fill: var(--wm-logo-bottom);
  }
}
